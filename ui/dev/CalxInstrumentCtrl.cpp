...
namespace CalXUI {
  ...
  CalxInstrumentCtrl::CalxInstrumentCtrl(wxWindow *win, wxWindowID id,
	...
	sessionButton->Bind(wxEVT_BUTTON, &CalxInstrumentCtrl::OnSessionSwitch,
						this);
	enabledButton = new wxButton(ctrlPanel, wxID_ANY, __("Enable/Disable"));
	ctrlSizer->Add(enabledButton, 0, wxALL | wxEXPAND);
	enabledButton->Bind(wxEVT_BUTTON, &CalxInstrumentCtrl::OnEnableButton,
						this);
	wxButton *confButton =
	...
	this->Bind(wxEVT_INSTRUMENT_CTRL_ENABLE, &CalxInstrumentCtrl::OnEnableEvent,
			   this);
  }
