...
namespace CalXUI {
  ...
  class CalxMotorMoveAction : public CalxAction {
   public:
	CalxMotorMoveAction(CalxMotorCtrl *ctrl, MotorController *dev, int dest,
  ...
  class CalxMotorCalibrationAction : public CalxAction {
   public:
	CalxMotorCalibrationAction(CalxMotorCtrl *ctrl, MotorController *dev,
							   int tr) {
	  this->ctrl = ctrl;
	  this->dev = dev;
	  this->tr = tr;
  ...
  CalxMotorCtrl::CalxMotorCtrl(wxWindow *win, wxWindowID id,
	...
	switchPowerButton->Bind(wxEVT_BUTTON, &CalxMotorCtrl::switchPowerClick,
							this);
