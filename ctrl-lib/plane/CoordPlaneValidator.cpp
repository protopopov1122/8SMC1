...
namespace CalX {
	...
	ErrorCode CoordPlaneValidator::move(motor_point_t dest, float speed, bool sync) {
	...
	ErrorCode CoordPlaneValidator::arc(motor_point_t dest, motor_point_t center, int splitter,
