...
namespace CalX {
	...
	ErrorCode FloatCoordPlane::arc(motor_point_t dest, motor_point_t center, int splitter, float speed, int div, bool clockwise, float scale, bool strict) {
		dest.x *= this->scale.x;
		dest.y *= this->scale.y;
		dest.x += this->offset.x;
		dest.y += this->offset.y;
		...
		return this->plane->arc(dest, center, splitter, speed * this->speed, div, clockwise, scale, strict);
	}
	...
	ErrorCode FloatCoordPlane::arc(coord_point_t dest, coord_point_t center, int splitter, double speed, int div, bool clockwise, float scale, bool strict) {
