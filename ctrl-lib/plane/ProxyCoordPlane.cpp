...
namespace CalX {
  ...
  ProxyCoordPlane::ProxyCoordPlane(std::shared_ptr<CoordPlane> base) : base(base) {}
  ...
  ErrorCode ProxyCoordPlane::arc(motor_point_t pos, motor_point_t cen, int spl, float speed, bool clw, float mul) {
  ...
  std::unique_ptr<CoordPlane> ProxyCoordPlane::clone(std::shared_ptr<CoordPlane> base) {
