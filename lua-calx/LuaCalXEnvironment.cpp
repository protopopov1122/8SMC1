...
namespace CalXLua {
	...
	int LuaCalXEnvironment::enableMotorPower(int id, bool power) {
		return static_cast<int>(env.enableMotorPower(static_cast<device_id_t>(id), power));
	}
	
	int LuaCalXEnvironment::motorMove(int id, int pos, double speed) {
		return static_cast<int>(env.motorMove(static_cast<device_id_t>(id), static_cast<motor_coord_t>(pos), speed));
	}
	
	int LuaCalXEnvironment::motorRelativeMove(int id, int pos, double speed) {
		return static_cast<int>(env.motorRelativeMove(static_cast<device_id_t>(id), static_cast<motor_coord_t>(pos), speed));
	}
	...
	int LuaCalXEnvironment::motorMoveToTrailer(int id, int tr) {
		return static_cast<int>(env.motorMoveToTrailer(static_cast<device_id_t>(id), static_cast<TrailerId>(tr)));
	}
	...
	int LuaCalXEnvironment::motorWaitWhileRunning(int id) {
		return static_cast<int>(env.motorWaitWhileRunning(static_cast<device_id_t>(id)));
	}
}  // namespace CalXLua
